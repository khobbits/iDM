...
alias idmstaff {
  if ($1 == invite) { msg #iDM.Staff $logo(INVITE) $s1($3) invited me into $s2($2) }
}
alias entrymsg {
...
alias botnews {
  return News: New gear in the store, type !store to see. !on attack,attack and !off attack,attack added. Polls: It's important for us to know what you think 12http://r.idm-bot.com/polls
}
alias bottag {
  if (!$1) {
