...
on $*:TEXT:/^[!@.](dm)?command(s)?$/Si:#: {
  ...
  $iif($left($1,1) == @,msgsafe #,notice $nick) $logo(COMMANDS) $&
    $s2(Account) $chr(91) $+ $s1(!money) $+ , $+ $s1(!account) $+ ,  $s1(!equip) $+ , $s1(!top/wtop/ltop N) $+ , $s1(!dmrank nick/N) $+ $chr(93) $&
  ...
  $iif($left($1,1) == @,msgsafe #,notice $nick) $logo(COMMANDS) $&
    ...
    $s2(Attacks) $chr(91) $+ $s1(!ags) $+ , $s1(!bgs) $+ , $s1(!sgs) $+ , $s1(!zgs) $+ , $s1(!whip) $+ , $s1(!guth) $+ , $s1(!ebolts) $+ , $s1(!dh) $+ , $s1(!dds) $+ , $s1(!dclaws) $+ , $s1(!dmace) $+ , $s1(!dbolts) $+ , $s1(!dhally) $+ , $s1(!gmaul) $+ , $s1(!rknives) $+ , $s1(!onyx) $+ , $s1(!dbow) $+ , $s1(!ice) $+ , $s1(!blood) $+ , $s1(!smoke) $+ , $s1(!fire) $+ , $s1(!earth) $+ , $s1(!arctic) $+ , $s1(!surf) $+ , $s1(!specpot) $+ $chr(93) $&
