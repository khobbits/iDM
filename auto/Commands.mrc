on *:TEXT:*:#: {
  ...
  if ($left($1,1) isin !@) && (($right($1,-1) == commands) || ($right($1,-1) == dmcommands)) {
    $iif($left($1,1) == !,notice $nick,msg #) $logo(COMMANDS) Starters $s2($chr(91)) $+ $s1(!dm) $+ , $s1(!stake) $+ , $s1(!enddm) $+ , $s1(!money) $+ , $s1(!top) $+ , $s1(!status) $+ , $s1(!buy) $+ , $s1(!sell) $+ , $s1(!store) $+ , $s1(!suggest) $+ $s2($chr(93)) Attacks $s2($chr(91)) $+ $s1(!whip) $+ , $s1(!dds) $+ , $s1(!gmaul) $+ , $s1(!guth) $+ , $s1(!cbow) $+ , $s1(!dbow) $+ , $s1(!dh) $+ , $s1(!bgs) $+ , $s1(!sgs) $+ , $s1(!ags) $+ , $s1(!zgs) $+ , $s1(!ice) $+ , $s1(!blood) $+ , $s1(!surf) $+ , $s1(!dclaws) $+ , $s1(!dscim) $+ , $s1(!dmace) $+ , $s1(!dlong) $+ , $s1(!dhally) $+ , $s1(!specpot) $+ $s2($chr(93)) 
