on $*:TEXT:/^[!@.](dm)?command(s)?$/Si:#: {
  ...
  $iif($left($1,1) == @,msg #,notice $nick) $logo(COMMANDS) Starters $s2($chr(91)) $+ $s1(!dm) $+ , $s1(!stake) $+ , $s1(!enddm) $+ , $s1(!money) $+ , $s1(!top) $+ , $s1(!status) $+ , $s1(!buy) $+ , $s1(!sell) $+ , $s1(!store) $+ $s2($chr(93)) Attacks $s2($chr(91)) $+ $s1(!ags) $+ , $s1(!bgs) $+ , $s1(!sgs) $+ , $s1(!zgs) $+ , $s1(!whip) $+ , $s1(!guth) $+ , $s1(!dscim) $+ , $s1(!dh) $+ , $s1(!dds) $+ , $s1(!dclaws) $+ , $s1(!dmace) $+ , $s1(!dlong) $+ , $s1(!dhally) $+ , $s1(!gmaul) $+ , $s1(!cbow) $+ , $s1(!dbow) $+ , $s1(!ice) $+ , $s1(!blood) $+ , $s1(!smoke) $+ , $s1(!surf) $+ , $s1(!specpot) $+ $s2($chr(93)) 
