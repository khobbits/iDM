...
;;; <returns><b>1</b> on success, or <b>$null</b> if there was an error.</returns>
;;; <remarks>
;;; This is an alias for <b>$sqlite_exec(...).file</b>
;;;
...
;;; <syntax>$sqlite_query ( conn, query ) [ .file ]</syntax>
...
;;; <summary>Executes a SQL query and returns data returned by it.</summary>
;;; <syntax>$sqlite_unbuffered_query ( conn, query ) [ .file ]</syntax>
...
;;; The trade off is that you can't random-access the unbuffered result set, like you can with buffered result sets. The following functions aren't supported on unbuffered results: <a href="sqlite_current.html">sqlite_current</a>, <a href="sqlite_current_bound.html">sqlite_current_bound</a>, <a href="sqlite_result.html">sqlite_result</a>, <a href="sqlite_next.html">sqlite_next</a>, <a href="sqlite_prev.html">sqlite_prev</a>, <a href="sqlite_has_more.html">sqlite_has_more</a>, <a href="sqlite_has_prev.html">sqlite_has_prev</a>, <a href="sqlite_seek.html">sqlite_seek</a>, <a href="sqlite_rewind.html">sqlite_rewind</a> and <a href="sqlite_key.html">sqlite_key</a>.
;;;
...
;;; <param name="item">The string to escape.</param>
...
;;; If $SQLITE_NUM is used, the hash table items will be field indexes, starting from index 1. If $SQLITE_ASSOC is used, the items will be field names. If $SQLIE_BOTH is used, both column indexes and names are used.
...
;;;     ; If you used $SQLITE_FETCH_NUM or $SQLITE_FETCH_ASSOC you could use 1 instead of first_name and 2 instead of last_name
...
;;;   echo -a Fetching results...
;;;   echo -a -
;;;   while ($sqlite_fetch_bound(%res, $SQLITE_BOTH)) {
...
;;; <remarks>
;;; If <i>&binvar</i> is specified the behaviour of $sqlite_fetch_single changes slightly. Instead of returning the first column's value, it will assign it to a binvar and return 1 on success.
...
;;; For more information about error handling, see <a href="errors.html">Handling Errors</a>.
;;;
;;; Unlike $sqlite_query and $sqlite_exec, $sqlite_prepare can only execute a single query. Extra queries seperated by a semi-colon are ignored, only the first one is prepared.
;;; To see guidelines for writing SQL queries with mIRC SQLite, see <a href="queries.html">Writing Queries</a>.
;;; </remarks>
;;; <example>
...
;;; <summary>Binds a column to a variable.</summary>
;;; <syntax>$sqlite_bind_column ( result, column, var [, datatype ] ) [ .name ]</syntax>
;;; <syntax>/sqlite_bind_column result column var [ datatype ]</syntax>
;;; <param name="result">The result identifier.</param>
;;; <param name="column">The column number of name to bind for. Must exist in the result set.</param>
;;; <param name="var">The variable or binary variable to bind the column for.</param>
...
;;;
;;; Using transactions when doing a batch of updates on database can greatly improve the performance. Enabling auto-commit mode means that you don't have to worry about remembering to start the transaction all the time, all you need to worry about is where you want all the pending changes to be committed.
;;;
...
;;;
;;; <remarks>It is usually ok to ignore the return value of $sqlite_autocommit when used to set autocommit mode, because the only case an error is returned is when an invalid <i>conn</i> is specified.</remarks>
;;; </remarks>
;;; <example>
